Использовано 86 % доступного пространства. … Когда свободное место закончится, вы не сможете создавать, редактировать и загружать файлы. Получите 100 ГБ за 45,00 грн. 11,00 грн. в месяц на 2 месяца. Это специальная цена только для вас.
#include <stdlib.h>
#include <math.h>
#include <string.h>
#include <ctype.h>
